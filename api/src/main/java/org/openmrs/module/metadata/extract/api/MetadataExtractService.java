...
import org.openmrs.module.metadata.extract.MetadataExtractConfig;
 ...
 */
public interface MetadataExtractService extends OpenmrsService {
	 ...
	 * @throws APIException
	 */
	@Authorized(MetadataExtractConfig.MODULE_PRIVILEGE)
