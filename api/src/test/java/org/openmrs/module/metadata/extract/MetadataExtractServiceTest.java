...
import org.openmrs.module.metadata.extract.api.impl.MetadataExtractServiceImpl;
import static org.mockito.Mockito.*;
import static org.hamcrest.Matchers.*;
import static org.junit.Assert.*;

/**
 * This is a unit test, which verifies logic in MetadataExtractService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class MetadataExtractServiceTest {
	
	@InjectMocks
	MetadataExtractServiceImpl basicModuleService;
